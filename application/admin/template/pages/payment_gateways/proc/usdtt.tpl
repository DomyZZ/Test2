{if $type=='sci'}
    <div class="form-group">
        <label for="sci_usdtt_payment_system" class="control-label">{$lang.label.payment_system}</label>
        <select name="payment_details[payment_system]" id="sci_usdtt_payment_system" class="form-control input-sm"
                onchange="show_ps_details('sci', 'usdtt')">
...
{if $type=='api'}
    <div class="form-group">
        <label for="api_usdtt_payment_system" class="control-label">{$lang.label.payment_system}</label>
        <select name="payment_details[api][payment_system]" id="api_usdtt_payment_system" class="form-control input-sm"
                onchange="show_ps_details('api', 'usdtt')">
