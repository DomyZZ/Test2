{if $type=='sci'}
    ...
    <div class="form-group">
        <label for="ps_pay_btn_pass" class="control-label">{$lang.label.pay_btn_pass}</label>
            ...
            <a href="javascript:void(0)" class="{($proc.payment_details.pay_btn_pass)?'':'hide'}" id="stp_eur_set_new_sci_pass" onclick="set_new_pass('stp_eur_set_new_sci_pass','stp_eur_cancel_new_sci_pass','ps_pay_btn_pass')">{$lang.label.set_new}</a>
            <a href="javascript:void(0)" class="hide" id="stp_eur_cancel_new_sci_pass" onclick="cancel_new_pass('stp_eur_set_new_sci_pass','stp_eur_cancel_new_sci_pass','ps_pay_btn_pass')">{$lang.label.cancel}</a>
    </div>

    <!-- Modal Help -->
    <div id="help-sci-stp-eur" class="modal fade" role="dialog">
...
{if $type=='api'}
    ...
    <div class="form-group">
        <label for="ps_api_api_pass" class="control-label">{$lang.label.api_password}</label>
            ...
            <a href="javascript:void(0)" class="{($proc.payment_details.api.api_pass)?'':'hide'}" id="stp_eur_set_new_api_pass" onclick="set_new_pass('stp_eur_set_new_api_pass','stp_eur_cancel_new_api_pass','ps_api_api_pass')">{$lang.label.set_new}</a>
            <a href="javascript:void(0)" class="hide" id="stp_eur_cancel_new_api_pass" onclick="cancel_new_pass('stp_eur_set_new_api_pass','stp_eur_cancel_new_api_pass','ps_api_api_pass')">{$lang.label.cancel}</a>
    </div>

    <!-- Modal Help -->
    <div id="help-api-stp-eur" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <!-- Modal content-->
            <div class="modal-content">
                <div class="modal-header">
