{if $type=='sci'}
    <div class="form-group">
        <label for="sci_ltc_payment_system" class="control-label">{$lang.label.payment_system}</label>
...
{if $type=='api'}
    <div class="form-group">
        <label for="api_ltc_payment_system" class="control-label">{$lang.label.payment_system}</label>
